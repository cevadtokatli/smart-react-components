"use strict";
(self["webpackChunksmart_react_components_page"] = self["webpackChunksmart_react_components_page"] || []).push([["default-src_containers_Popover_tsx"],{

/***/ "./src/containers/Popover.tsx":
/*!************************************!*\
  !*** ./src/containers/Popover.tsx ***!
  \************************************/
...
/* harmony import */ var _smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @smart-react-components/ui/Popover */ "./node_modules/@smart-react-components/ui/Popover/index.js");
/* harmony import */ var _smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2__);
...
const Popover = () => {
    (0,_hooks_usePage__WEBPACK_IMPORTED_MODULE_16__["default"])({ title: 'Popover' });
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_elements_Page__WEBPACK_IMPORTED_MODULE_14__["default"], null,
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_elements_Content__WEBPACK_IMPORTED_MODULE_12__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("h1", { id: "popover" }, "Popover"),
                ...
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("p", null, "Popover component takes two children elements; the first of which for the toggle element and the second for the content element."),
                ...
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_components_PropsTable__WEBPACK_IMPORTED_MODULE_9__["default"], { props: [
                        {
                            name: 'children',
                            type: '[JSX.Element, JSX.Element] | [JSX.Element, JSX.Element, JSX.Element]',
                            isRequired: true,
                            description: 'The first element for the toggle element, and the second element for the popover content. If three element is given, the second element is for the popover header and the last element is for the popover content.',
                        },
                        {
                            name: 'status',
                            type: 'boolean',
                            description: 'Popover display status.',
                        },
                        {
                            name: 'setStatus',
                        ...
                        },
                        {
                            ...
                            defaultValue: 'medium',
                            description: 'Popover size, has responsive support.',
                        },
                        {
                            name: 'position',
                            ...
                            defaultValue: 'RIGHT',
                            description: 'Position of the popover element by the toggle element. If the popover element gets overflown in the given position, it is rendered at another available position.',
                        },
                        {
                            name: 'space',
                            type: 'number',
                            defaultValue: '0',
                            description: 'Space between the toggle and the popover element.',
                        },
                        {
                ...
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("p", null, "You can set the trigger interaction for the Popover."),
                ...
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("p", null,
                    "Popover provides an event for you to set position custom in case you have modified the box element afterwards. When you trigger ",
                    react__WEBPACK_IMPORTED_MODULE_3___default().createElement("code", null, "src.popover.setPosition"),
...
export default () => (
  <ButtonList>
    <Popover>
      ...
      <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.</span>
    </Popover>
    <Popover palette="!dynamic">
      <Button palette="!dynamic" marginLeft="$length.3" marginTop="$length.3">!Dynamic</Button>
      <span>Popover Header</span>
      <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.</span>
    </Popover>
    ...
    <Popover palette="info">
      ...
      <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.</span>
                        ...
                        output: (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Button_ButtonList__WEBPACK_IMPORTED_MODULE_1___default()), null,
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), null,
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { palette: "!dynamic" },
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Button__WEBPACK_IMPORTED_MODULE_0___default()), { palette: "!dynamic", marginLeft: "$length.3", marginTop: "$length.3" }, "!Dynamic"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { palette: "primary" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { palette: "secondary" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { palette: "success" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { palette: "danger" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { palette: "warning" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { palette: "info" },
  ...
  <ButtonList>
    ...
    <Popover isSoft palette="info">
      ...
      <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.</span>
                        ...
                        output: (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Button_ButtonList__WEBPACK_IMPORTED_MODULE_1___default()), null,
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { isSoft: true },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { isSoft: true, palette: "!dynamic" },
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Button__WEBPACK_IMPORTED_MODULE_0___default()), { isSoft: true, palette: "!dynamic", marginLeft: "$length.3", marginTop: "$length.3" }, "!Dynamic"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { isSoft: true, palette: "primary" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { isSoft: true, palette: "secondary" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { isSoft: true, palette: "success" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { isSoft: true, palette: "danger" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { isSoft: true, palette: "warning" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { isSoft: true, palette: "info" },
...
export default () => (
  <ButtonList>
    ...
    <Popover size="small" sizeMd="medium" sizeLg="large">
      ...
      <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.</span>
                        ...
                        output: (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Button_ButtonList__WEBPACK_IMPORTED_MODULE_1___default()), null,
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { size: "small" },
                            ...
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), null,
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { size: "large" },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { size: "small", sizeMd: "medium", sizeLg: "large" },
                        ...
                        code: `import Button from '@smart-react-components/ui/Button'
import ButtonList from '@smart-react-components/ui/Button/ButtonList'
import Popover, { Position } from '@smart-react-components/ui/Popover'
import React from 'react'
      ...
      <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.</span>
                        ...
                        output: (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Button_ButtonList__WEBPACK_IMPORTED_MODULE_1___default()), null,
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), null,
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { position: _smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2__.Position.LEFT },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { position: _smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2__.Position.TOP },
                                ...
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Popover Header"),
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("span", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lobortis enim.")),
                            react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2___default()), { position: _smart_react_components_ui_Popover__WEBPACK_IMPORTED_MODULE_2__.Position.BOTTOM },
                ...
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_components_AttributesTable__WEBPACK_IMPORTED_MODULE_4__["default"], { attrs: [
                        ...
                        {
                            name: 'fontWeight.popover',
                            type: 'string',
                            description: react__WEBPACK_IMPORTED_MODULE_3___default().createElement((react__WEBPACK_IMPORTED_MODULE_3___default().Fragment), null,
                                "Header ",
                                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("code", null, "font-weight"),
                                " value."),
                        },
                        {
                            name: 'radius.popover',
                        ...
                        {
                            name: 'transition.popoverDuration',
                            type: 'number',
...
//# sourceMappingURL=ba0c41f00cfaa69c0520.js.map