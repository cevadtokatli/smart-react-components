...
const NavLink: React.FC<Props> = ({children,elementProps=DV.JSX_ELEMENT_PROPS,to,path,exact,emptyQueryActive}) => {
    const {click,active,activating} = useLinkMethods({to,path,exact,emptyQueryActive})
