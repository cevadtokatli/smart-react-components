...
const Button = React.forwardRef<HTMLElement, Props>((props, forwardRef) => {
  ...
  const waveEffectPalette = React.useMemo(() => getWaveEffectPalette(props, theme.$.vars.isDarkMode), [props.palette, props.isOutline, props.isSoft, props.isLink, props.waveEffectPalette, theme.$.vars.isDarkMode])
