...
export default styled(Span)<Props>(({ theme, isDisabled, palette }: Props) => `
  border: solid 2px ${theme.$.palette[palette].colorPicker?.lightFont ?? theme.$.color.light.background};
  border-radius: 100%;
